...
function estilosReporteColegio() {
  return `.reporte-colegio{width:100%;padding:18px;background:#fff;color:#111;font-family:Arial,sans-serif}.reporte-colegio>header{text-align:center}.reporte-colegio>header h1{margin:0;font-size:12px}.reporte-colegio>header h2{margin:6px 0 10px;font-size:11px}.datos-colegio{display:grid;grid-template-columns:1fr 1fr;margin-bottom:8px;border:1px solid #777}.datos-colegio>div{display:grid;grid-template-columns:145px 1fr;min-height:25px;border-bottom:1px solid #aaa}.datos-colegio b,.datos-colegio span{padding:5px 7px;font-size:8px}.datos-colegio b{background:#eee;text-transform:uppercase}.tabla-colegio{width:100%;border-radius:0;overflow:visible}.tabla-colegio table{width:100%;table-layout:auto;font-size:7px}.tabla-colegio th,.tabla-colegio td{padding:4px 2px;border-color:#777;white-space:nowrap}.tabla-colegio thead tr:first-child>th:nth-child(1){width:2.2%}.tabla-colegio thead tr:first-child>th:nth-child(2){width:6%}.tabla-colegio thead tr:first-child>th:nth-child(3){width:14%}.tabla-colegio thead tr:first-child>th:nth-child(4){width:7%}.tabla-colegio thead tr:first-child>th:nth-child(5){width:3.5%}.tabla-colegio thead th{background:#e7e6e6;color:#111}.tabla-colegio tbody td:nth-child(3){white-space:normal}.codigo-colegio{font-weight:700}.leyenda-colegio{margin-top:8px;font-size:8px}@media print{.reporte-colegio{width:100%;padding:0}.tabla-colegio table{font-size:6px}.tabla-colegio th,.tabla-colegio td{padding:3px 1px}}`;
}
