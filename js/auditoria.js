...
function nombreHorarioAuditoria(nombre){const limpio=String(nombre||"").trim();if(!limpio)return "";return /^horario\b/i.test(limpio)?limpio:`Horario ${limpio}`;}
